        ...
        foreach ( $blocks as $block ) {
            if ( file_exists(get_template_directory() . '/resources/views/blocks/' . $block . '/block.json') ) {
                ...
                if ( file_exists(get_template_directory() . '/resources/views/blocks/' . $block . '/style.ccss') ) {
                    wp_register_style('block-' . $block, get_template_directory_uri() . '/resources/views/blocks/' . $block . '/style.css', [], filemtime(get_template_directory() . '/resources/views/blocks/' . $block . '/style.css'));
                }
